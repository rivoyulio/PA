        ...
        <div class="row">
            ...
            <div class="col-md-8 mt-5">
                <form action="/admin/data/prodi/{{ $data->id_prodi }}" method="post" enctype="multipart/form-data">
                    ...
                    @csrf
                    <div class="card">
                        <h5 class="card-header text-center font-weight-bold">Edit Data Prodi</h5><br>
                        <div class="card-body">
                            <div class="mb-3">
                                <label for="exampleInputPassword1" class="form-label" style="text-align: center;">Kode Prodi</label>
                                <input type="text" name="kode_prodi" class="form-control @error('kode_prodi') is-invalid @enderror" id="kode_prodi" value="{{ old('kode_prodi',$data->kode_prodi )}}" autofocus placeholder="Kode Prodi">
                                @error('kode_prodi')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="nama_prodi" class="form-control @error('nama_prodi') is-invalid @enderror" id="nama_prodi" value="{{ old('nama_prodi',$data->nama_prodi )}}" autofocus placeholder="Nama Prodi">
                                @error('nama_prodi')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="jenjang" class="form-control @error('jenjang') is-invalid @enderror" id="jenjang" value="{{ old('jenjang',$data->jenjang )}}" autofocus placeholder="Jenjang">
                                @error('jenjang')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('id_sp') is-invalid @enderror" name="id_user">
                                    ...
                                    @foreach($users as $user)
                                        @if (old('id_user', $data->id_user) == $user->id_user)
