        ...
        <div class="row">
            ...
            <div class="col-lg">
                <div class="row">
                    ...
                    <!-- Recent Sales -->
                    <div class="col-12">
                        <a href="/kelas/kelascreate" type="button" class="btn btn-primary btn-sm mb-4">+ Tambah Mahasiswa</a>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    {{-- <a href="{{ url('/kelas/' . $kelas->id_kelas) }}" class="btn btn-link"><span
                                                        ...
                                                        {{-- <a href="{{ url('/kelas/' . $kelas->id . '/edit/') }}" class="btn btn-link"><span
                                                            class="badge bg-warning text-dark"><i
                                                            class="bi bi-info-circle"></i> Edit</span></a> --}}

                                                        <form
                                                            action="{{ '/kelas/detail/delete/' . $mahasiswa->id_mhs }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('DELETE')
