    ...
    <div class="card">
        <div class="row">
            ...
            <div class="col-md-8 mt-5">
                <form action="/admin/data/kelas/{{ $data->id_kelas }}" method="post" enctype="multipart/form-data">
                    @method('PUT')
                    @csrf
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <input type="text" name="nama_kelas" class="form-control @error('nama_kelas') is-invalid @enderror" id="nama_kelas" value="{{ old('nama_kelas',$data->nama_kelas )}}" autofocus placeholder="Nama Kelas">
                                @error('nama_kelas')
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" name="id_dosen" aria-label="Default select example">
                                        ...
                                        @foreach($dosens as $dosen)
                                            @if (old('id_dosen',$data->id_dosen) == $dosen->id_dosen)
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="tahun_angkatan" class="form-control @error('tahun_angkatan') is-invalid @enderror" id="tahun_angkatan" value="{{ old('tahun_angkatan',$data->tahun_angkatan )}}" autofocus placeholder="Tahun Angkatan">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="jumlah" class="form-control @error('jumlah') is-invalid @enderror" id="jumlah" value="{{ old('jumlah',$data->jumlah )}}" autofocus placeholder="Jumlah Mahasiswa">
                                @error('jumlah')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
